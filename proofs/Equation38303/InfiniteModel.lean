...
theorem code_no_pair_left (v k : CM) :
  ...
  cases qs0 with
  | raw =>
    have he : q_H1 = q_v0 := Eq.trans (Eq.trans (Eq.trans (Eq.symm (Eq.trans (Eq.trans (Eq.symm (rfl)) (Eq.trans (congrArg (fun q => (L q)) (ha)) (rfl))) (rfl))) (Eq.trans (hb) (rfl))) (rfl)) (Eq.symm (rfl))
