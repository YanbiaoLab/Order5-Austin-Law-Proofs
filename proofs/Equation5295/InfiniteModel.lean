...
theorem nr0 (x v0 v1 H0 : CM)
  ...
  | raw =>
    ...
    | raw =>
      ...
      have cyc : q_v0 = (p q_v0 (p q_v0 (p q_x q_v0))) := Eq.trans (Eq.symm (Eq.trans (Eq.trans (Eq.symm (rfl)) (Eq.trans (e0) (rfl))) (rfl))) (Eq.trans (e2) (rfl))
    ...
    | hit qs0h =>
      ...
      have cyc : q_v0 = (p q_v0 (p q_v0 q_H0)) := Eq.trans (Eq.symm (Eq.trans (Eq.trans (Eq.symm (rfl)) (Eq.trans (e0) (rfl))) (rfl))) (Eq.trans (e2) (rfl))
  ...
  | hit s0h =>
    ...
    | raw =>
      ...
      have hx : sz q_v0 < sz (p q_v1 (p q_v0 (p q_v0 (p q_x q_v0)))) := by
        ...
        have ev : sz H0 = sz (p q_v1 (p q_v0 (p q_v0 (p q_x q_v0)))) := congrArg sz (Eq.trans (p1) (rfl))
    ...
    | hit qs0h =>
      ...
      have hx : sz q_v0 < sz (p q_v1 (p q_v0 (p q_v0 q_H0))) := by
        have q := hcB.1
        have eu : sz v0 = sz q_v0 := congrArg sz (Eq.trans (p0) (rfl))
        have ev : sz H0 = sz (p q_v1 (p q_v0 (p q_v0 q_H0))) := congrArg sz (Eq.trans (p1) (rfl))
        have q1 : sz q_v0 < sz H0 := lt_of_eq_of_lt eu.symm q
        exact lt_of_lt_of_eq q1 ev
...
theorem nr1 (x v0 v1 H0 : CM)
  ...
  | raw =>
    ...
    | raw =>
      ...
      have cyc : q_v1 = (p q_v1 (p q_x q_v1)) := Eq.trans (Eq.symm (Eq.trans (Eq.trans (Eq.symm (rfl)) (Eq.trans (e0) (rfl))) (Eq.trans (Eq.trans (Eq.symm (Eq.trans (Eq.trans (Eq.symm (rfl)) (Eq.trans (e0) (rfl))) (rfl))) (Eq.trans (e1) (rfl))) (rfl)))) (Eq.trans (e3) (Eq.trans (congrArg (fun q => p q (p q_x q_v0)) (Eq.trans (Eq.trans (Eq.symm (Eq.trans (Eq.trans (Eq.symm (rfl)) (Eq.trans (e0) (rfl))) (rfl))) (Eq.trans (e1) (rfl))) (rfl))) (congrArg (fun q => p q_v1 q) (congrArg (fun q => p q_x q) (Eq.trans (Eq.trans (Eq.symm (Eq.trans (Eq.trans (Eq.symm (rfl)) (Eq.trans (e0) (rfl))) (rfl))) (Eq.trans (e1) (rfl))) (rfl))))))
    ...
    | hit qs0h =>
      ...
      have cyc : q_v1 = (p q_v1 q_H0) := Eq.trans (Eq.symm (Eq.trans (Eq.trans (Eq.symm (rfl)) (Eq.trans (e0) (rfl))) (Eq.trans (Eq.trans (Eq.symm (Eq.trans (Eq.trans (Eq.symm (rfl)) (Eq.trans (e0) (rfl))) (rfl))) (Eq.trans (e1) (rfl))) (rfl)))) (Eq.trans (e3) (congrArg (fun q => p q q_H0) (Eq.trans (Eq.trans (Eq.symm (Eq.trans (Eq.trans (Eq.symm (rfl)) (Eq.trans (e0) (rfl))) (rfl))) (Eq.trans (e1) (rfl))) (rfl))))
  ...
  | hit s0h =>
    ...
    | raw =>
      ...
      have badlt : sz v0 < sz H0 := by
        rw [Eq.trans (p0) (rfl), Eq.trans (p2) (rfl)]
        exact sz_lt_p_left q_v0 (p q_v0 (p q_x q_v0))
...
theorem nr2 (x v0 v1 H0 : CM)
  ...
  cases s0 with
  | raw =>
    have he : q_H0 = q_v0 := Eq.trans (rfl) (Eq.symm (Eq.trans (Eq.trans (Eq.symm (Eq.trans (Eq.trans (Eq.symm (rfl)) (Eq.trans (congrArg (fun q => (L q)) (hb)) (rfl))) (Eq.trans (Eq.trans (Eq.symm (Eq.trans (Eq.trans (Eq.symm (rfl)) (Eq.trans (congrArg (fun q => (L q)) (hb)) (rfl))) (rfl))) (Eq.trans (congrArg (fun q => (L (R q))) (hb)) (rfl))) (rfl)))) (Eq.trans (congrArg (fun q => (R (R (R q)))) (hb)) (rfl))) (rfl)))
  ...
  | hit s0h =>
    ...
    | raw =>
      ...
      have badlt : sz v0 < sz H0 := by
        rw [Eq.trans (p1) (rfl), Eq.trans (p3) (Eq.trans (congrArg (fun q => p q (p q_x q_v0)) (Eq.trans (p2.symm) (Eq.trans (p1) (rfl)))) (congrArg (fun q => p q_v1 q) (congrArg (fun q => p q_x q) (Eq.trans (p2.symm) (Eq.trans (p1) (rfl))))))]
        exact sz_lt_p_left q_v1 (p q_x q_v1)
      exact (Nat.not_lt_of_ge (Nat.le_of_lt badlt) s0hB.2).elim
    | hit qs0h =>
      have hcB := code_bounds hc
      have s0hB := code_bounds s0h
      ...
      have z4 := congrArg sz p4
      have badlt : sz v0 < sz H0 := by
        rw [Eq.trans (p1) (rfl), Eq.trans (p3) (congrArg (fun q => p q q_H0) (Eq.trans (p2.symm) (Eq.trans (p1) (rfl))))]
        exact sz_lt_p_left q_v1 q_H0
      exact (Nat.not_lt_of_ge (Nat.le_of_lt badlt) s0hB.2).elim
