...
- 对偶：[Equation32280](../Equation32280/README.md)
- 原表：20.2
- 方程：`x = y ◇ ((z ◇ ((x ◇ y) ◇ y)) ◇ y)`
...
随后已通过极光云 **judge-v3-repl** 实际验证，结果为 **accepted**。任务 ID：`d188d697d8cd4bcc8cda676b1f3e42dc`。见[完整结果](../validation/aurora/Equation13992/latest.json)和[实际提交的单文件证书](../validation/aurora/Equation13992/certificate.lean)。原来的本地编译记录和历史验收状态保留。
