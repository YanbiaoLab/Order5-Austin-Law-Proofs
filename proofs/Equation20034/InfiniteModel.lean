...
inductive Code : CM → CM → CM → Prop
  | r0 (q1 q2 q0 : CM) : Code (p q1 q1) (p (p q2 (p q0 q0)) q2) q0
def CodeCases (a b o : CM) : Prop := (∃ q1 q2 q0 : CM, a = (p q1 q1) ∧ b = (p (p q2 (p q0 q0)) q2) ∧ o = q0 ∧ sz a = sz (p q1 q1) ∧ sz b = sz (p (p q2 (p q0 q0)) q2) ∧ sz o = sz q0) ∨ False
...
theorem code_nf {a b o : CM} (ha : NF a) (hb : NF b) (h : Code a b o) : NF o := by
  cases h with
  | r0 => exact hb.1.2.1.1
theorem redex0_not_nf (q1 q2 q0 : CM) :
    ¬ NF (p (p q1 q1) (p (p q2 (p q0 q0)) q2)) := by
  intro h
  exact h.2.2 ⟨q0, Code.r0 q1 q2 q0⟩
...
theorem eval_nf {a b : CM} (ha : NF a) (hb : NF b) : NF (eval a b) := by
  ...
  · rw [eval_raw h]
    exact ⟨ha, hb, h⟩
@[grind unfold] abbrev C0 (q1 q2 q0 : CM) (a b o : CM) : Prop := a = (p q1 q1) ∧ b = (p (p q2 (p q0 q0)) q2) ∧ o = q0 ∧ sz a = sz (p q1 q1) ∧ sz b = sz (p (p q2 (p q0 q0)) q2) ∧ sz o = sz q0
inductive EvalCases (a b o : CM) : Prop
  | r0 (q1 q2 q0 : CM) (h : C0 q1 q2 q0 a b o) : EvalCases a b o
...
theorem eval_cases (a b : CM) : EvalCases a b (eval a b) := by
  ...
  · let o := Classical.choose h
    ...
    · rcases cc0 with ⟨q1, q2, q0, hc0⟩
      exact .r0 q1 q2 q0 hc0
    · contradiction
