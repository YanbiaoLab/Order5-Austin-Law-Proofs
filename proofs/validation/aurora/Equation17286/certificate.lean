...
theorem submission : Goal := by
  ...
  · exact submission.Equation17286Tree.source_law_explicit
  · intro h
...
example (x y z : submission.CM) : x = (y ◇ x) ◇ (z ◇ (z ◇ (x ◇ z))) :=
  submission.Equation17286Tree.source_law_explicit x y z

#print axioms submission
#print axioms submission.CM.tower_injective
#print axioms submission.Equation17286Tree.infinite_model
