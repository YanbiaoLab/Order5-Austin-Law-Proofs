  ...
  | @left _ t0 _ h0 =>
    ...
    | root hr =>
      ...
      · rw [ho]
        ...
        subst x0
        subst x1
        exact ⟨(T.r q0 (T.c q1 q2 q0)), (Steps.refl _), (Steps.cons (Step.root (Root.r5 q1 q2 q0)) (Steps.refl _))⟩
      · rw [ho]
        have e0 := (T.m.inj he).1
        have e1 := (T.m.inj he).2
        subst x0
      ...
      · rw [ho]
        ...
        subst x0
        subst x1
        exact ⟨(T.r q0 (T.c q0 q1 q2)), (Steps.refl _), (Steps.cons (Step.root (Root.r4 q2 (T.c q0 q1 q2))) (Steps.cons (Step.leftR (T.c q0 q1 q2) (Step.root (Root.r3 q2 q0 q1))) (Steps.refl _)))⟩
      · rw [ho]
        cases he
      · rw [ho]
        have e0 := (T.m.inj he).1
      ...
      · rw [ho]
        ...
        subst x0
        subst x1
        exact ⟨(T.r (T.m q0 q1) (T.c q1 q2 q1)), (Steps.refl _), (Steps.cons (Step.root (Root.r7 q0 q1 (T.c q1 q2 q1))) (Steps.cons (Step.leftR (T.c q1 q2 q1) (Step.right q0 (Step.root (Root.r6 q1 q2)))) (Steps.refl _)))⟩
      · rw [ho]
        have e0 := (T.m.inj he).1
        have e1 := (T.m.inj he).2
        subst x0
        subst x1
        exact ⟨(T.r (T.r q0 q1) (T.c q1 q2 q1)), (Steps.refl _), (Steps.cons (Step.root (Root.r7 (T.m q0 q1) q1 (T.c q1 q2 q1))) (Steps.cons (Step.leftR (T.c q1 q2 q1) (Step.right (T.m q0 q1) (Step.root (Root.r6 q1 q2)))) (Steps.cons (Step.leftR (T.c q1 q2 q1) (Step.root (Root.r1 q0 q1))) (Steps.refl _))))⟩
      · rw [ho]
        have e0 := (T.m.inj he).1
        have e1 := (T.m.inj he).2
        subst x0
      ...
      · rw [ho]
        ...
        subst x0
        subst x1
        exact ⟨(T.r (T.c q0 q1 q2) (T.c q2 q3 q2)), (Steps.refl _), (Steps.cons (Step.root (Root.r7 (T.m q0 (T.r q1 q2)) q2 (T.c q2 q3 q2))) (Steps.cons (Step.leftR (T.c q2 q3 q2) (Step.right (T.m q0 (T.r q1 q2)) (Step.root (Root.r6 q2 q3)))) (Steps.cons (Step.leftR (T.c q2 q3 q2) (Step.root (Root.r2 q0 q1 q2))) (Steps.refl _))))⟩
      · rw [ho]
        have e0 := (T.m.inj he).1
        have e1 := (T.m.inj he).2
        subst x0
        subst x1
        exact ⟨(T.r q0 (T.c (T.c q0 q1 q2) q3 (T.c q0 q1 q2))), (Steps.refl _), (Steps.cons (Step.root (Root.r7 q2 (T.c q0 q1 q2) (T.c (T.c q0 q1 q2) q3 (T.c q0 q1 q2)))) (Steps.cons (Step.leftR (T.c (T.c q0 q1 q2) q3 (T.c q0 q1 q2)) (Step.right q2 (Step.root (Root.r6 (T.c q0 q1 q2) q3)))) (Steps.cons (Step.leftR (T.c (T.c q0 q1 q2) q3 (T.c q0 q1 q2)) (Step.root (Root.r3 q2 q0 q1))) (Steps.refl _))))⟩
    | @left _ t1 _ h1 =>
    ...
    | @right _ _ t1 h1 =>
      ...
      | root hr =>
        ...
        · rw [ho]
          ...
          subst x1
          subst x2
          exact ⟨(T.c x0 q0 (T.c q0 q1 q0)), (Steps.refl _), (Steps.cons (Step.root (Root.r9 x0 q0 q1)) (Steps.refl _))⟩
        · rw [ho]
          cases he
        · rw [ho]
          cases he
...
namespace submission.Austin13764
open T
theorem peak3 (x0 : T) (x1 : T) (x2 : T) {u : T} (h : Step (T.m x0 (T.c x1 x2 x0)) u) : Join x1 u := by
  cases h with
  | root hr =>
    rcases root_cases hr with ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩
    · rw [ho]
    ...
    · rw [ho]
      ...
      omega
  | @left _ t0 _ h0 =>
    exact ⟨x1, (Steps.refl _), (Steps.cons (Step.right t0 (Step.thirdC x1 x2 h0)) (Steps.cons (Step.root (Root.r3 t0 x1 x2)) (Steps.refl _)))⟩
  | @right _ _ t0 h0 =>
    cases h0 with
    | root hr =>
      rcases root_cases hr with ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩
    ...
    | @thirdC _ _ _ t1 h1 =>
      exact ⟨x1, (Steps.refl _), (Steps.cons (Step.left (T.c x1 x2 t1) h1) (Steps.cons (Step.root (Root.r3 t1 x1 x2)) (Steps.refl _)))⟩
end submission.Austin13764
  ...
  | @left _ t0 _ h0 =>
    ...
    | root hr =>
      ...
      · rw [ho]
        ...
        subst x0
        subst x1
        exact ⟨q0, (Steps.cons (Step.leftR (T.c q0 q1 q0) (Step.root (Root.r3 q0 q0 q1))) (Steps.cons (Step.root (Root.r6 q0 q1)) (Steps.refl _))), (Steps.cons (Step.root (Root.r3 q0 q0 q1)) (Steps.refl _))⟩
      · rw [ho]
        cases he
      · rw [ho]
        cases he
...
namespace submission.Austin13764
open T
theorem peak5 (x0 : T) (x1 : T) (x2 : T) {u : T} (h : Step (T.m x0 (T.c x0 x1 x2)) u) : Join (T.r x2 (T.c x0 x1 x2)) u := by
  cases h with
  | root hr =>
    rcases root_cases hr with ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩
    · rw [ho]
    ...
    · rw [ho]
      ...
      subst x1
      subst x2
      exact ⟨(T.r q2 (T.c q0 q1 q2)), (Steps.refl _), (Steps.refl _)⟩
    · rw [ho]
      cases he
    · rw [ho]
      have e0 := (T.m.inj he).1
    ...
    · rw [ho]
      ...
      omega
  | @left _ t0 _ h0 =>
    exact ⟨(T.r x2 (T.c t0 x1 x2)), (Steps.cons (Step.rightR x2 (Step.firstC x1 x2 h0)) (Steps.refl _)), (Steps.cons (Step.right t0 (Step.firstC x1 x2 h0)) (Steps.cons (Step.root (Root.r5 t0 x1 x2)) (Steps.refl _)))⟩
  | @right _ _ t0 h0 =>
    cases h0 with
    | root hr =>
      rcases root_cases hr with ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩
      ...
      · rw [ho]
        cases he
    | @firstC _ t1 _ _ h1 =>
      exact ⟨(T.r x2 (T.c t1 x1 x2)), (Steps.cons (Step.rightR x2 (Step.firstC x1 x2 h1)) (Steps.refl _)), (Steps.cons (Step.left (T.c t1 x1 x2) h1) (Steps.cons (Step.root (Root.r5 t1 x1 x2)) (Steps.refl _)))⟩
    | @secondC _ _ t1 _ h1 =>
      exact ⟨(T.r x2 (T.c x0 t1 x2)), (Steps.cons (Step.rightR x2 (Step.secondC x0 x2 h1)) (Steps.refl _)), (Steps.cons (Step.root (Root.r5 x0 t1 x2)) (Steps.refl _))⟩
    | @thirdC _ _ _ t1 h1 =>
      exact ⟨(T.r t1 (T.c x0 x1 t1)), (Steps.cons (Step.leftR (T.c x0 x1 x2) h1) (Steps.cons (Step.rightR t1 (Step.thirdC x0 x1 h1)) (Steps.refl _))), (Steps.cons (Step.root (Root.r5 x0 x1 t1)) (Steps.refl _))⟩
end submission.Austin13764
...
namespace submission.Austin13764
open T
theorem peak6 (x0 : T) (x1 : T) {u : T} (h : Step (T.r x0 (T.c x0 x1 x0)) u) : Join x0 u := by
  cases h with
  | root hr =>
    rcases root_cases hr with ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩
    · rw [ho]
    ...
    · rw [ho]
      cases he
  | @leftR _ t0 _ h0 =>
    exact ⟨t0, (Steps.cons h0 (Steps.refl _)), (Steps.cons (Step.rightR t0 (Step.firstC x1 x0 h0)) (Steps.cons (Step.rightR t0 (Step.thirdC t0 x1 h0)) (Steps.cons (Step.root (Root.r6 t0 x1)) (Steps.refl _))))⟩
  | @rightR _ _ t0 h0 =>
    cases h0 with
    | root hr =>
      rcases root_cases hr with ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩
      ...
      · rw [ho]
        cases he
    | @firstC _ t1 _ _ h1 =>
      exact ⟨t1, (Steps.cons h1 (Steps.refl _)), (Steps.cons (Step.leftR (T.c t1 x1 x0) h1) (Steps.cons (Step.rightR t1 (Step.thirdC t1 x1 h1)) (Steps.cons (Step.root (Root.r6 t1 x1)) (Steps.refl _))))⟩
    | @secondC _ _ t1 _ h1 =>
      exact ⟨x0, (Steps.refl _), (Steps.cons (Step.root (Root.r6 x0 t1)) (Steps.refl _))⟩
    | @thirdC _ _ _ t1 h1 =>
      exact ⟨t1, (Steps.cons h1 (Steps.refl _)), (Steps.cons (Step.leftR (T.c x0 x1 t1) h1) (Steps.cons (Step.rightR t1 (Step.firstC x1 t1 h1)) (Steps.cons (Step.root (Root.r6 t1 x1)) (Steps.refl _))))⟩
end submission.Austin13764
    ...
    | @rightR _ _ t1 h1 =>
      ...
      | root hr =>
        ...
        · rw [ho]
          ...
          subst x1
          subst x2
          exact ⟨(T.c (T.m x0 q0) q0 (T.c q0 q1 q0)), (Steps.cons (Step.firstC q0 (T.c q0 q1 q0) (Step.right x0 (Step.root (Root.r6 q0 q1)))) (Steps.refl _)), (Steps.cons (Step.root (Root.r10 x0 q0 q1)) (Steps.refl _))⟩
        · rw [ho]
          cases he
        · rw [ho]
          cases he
...
namespace submission.Austin13764
open T
theorem peak10 (x0 : T) (x1 : T) (x2 : T) {u : T} (h : Step (T.m (T.r x0 x1) (T.c x1 x2 x1)) u) : Join (T.c (T.m x0 x1) x1 (T.c x1 x2 x1)) u := by
  cases h with
  | root hr =>
    rcases root_cases hr with ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩
    · rw [ho]
    ...
    · rw [ho]
      ...
      subst x1
      subst x2
      exact ⟨(T.c (T.m q0 q1) q1 (T.c q1 q2 q1)), (Steps.refl _), (Steps.refl _)⟩
    · rw [ho]
      have e0 := (T.m.inj he).1
      have e1 := (T.m.inj he).2
      cases e0
  ...
  | @left _ t0 _ h0 =>
    ...
    | root hr =>
      ...
      · rw [ho]
        ...
        subst x0
        subst x1
        exact ⟨(T.c q0 (T.c q0 q1 q0) (T.c (T.c q0 q1 q0) x2 (T.c q0 q1 q0))), (Steps.cons (Step.firstC (T.c q0 q1 q0) (T.c (T.c q0 q1 q0) x2 (T.c q0 q1 q0)) (Step.root (Root.r3 q0 q0 q1))) (Steps.refl _)), (Steps.cons (Step.root (Root.r13 q0 q1 q0 x2)) (Steps.refl _))⟩
      · rw [ho]
        cases he
      · rw [ho]
        cases he
      ...
      · rw [ho]
        cases he
    | @leftR _ t1 _ h1 =>
      exact ⟨(T.c (T.m t1 x1) x1 (T.c x1 x2 x1)), (Steps.cons (Step.firstC x1 (T.c x1 x2 x1) (Step.left x1 h1)) (Steps.refl _)), (Steps.cons (Step.root (Root.r10 t1 x1 x2)) (Steps.refl _))⟩
    | @rightR _ _ t1 h1 =>
      exact ⟨(T.c (T.m x0 t1) t1 (T.c t1 x2 t1)), (Steps.cons (Step.firstC x1 (T.c x1 x2 x1) (Step.right x0 h1)) (Steps.cons (Step.secondC (T.m x0 t1) (T.c x1 x2 x1) h1) (Steps.cons (Step.thirdC (T.m x0 t1) t1 (Step.firstC x2 x1 h1)) (Steps.cons (Step.thirdC (T.m x0 t1) t1 (Step.thirdC t1 x2 h1)) (Steps.refl _))))), (Steps.cons (Step.right (T.r x0 t1) (Step.firstC x2 x1 h1)) (Steps.cons (Step.right (T.r x0 t1) (Step.thirdC t1 x2 h1)) (Steps.cons (Step.root (Root.r10 x0 t1 x2)) (Steps.refl _))))⟩
  | @right _ _ t0 h0 =>
    cases h0 with
    | root hr =>
      rcases root_cases hr with ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩
      ...
      · rw [ho]
        cases he
    | @firstC _ t1 _ _ h1 =>
      exact ⟨(T.c (T.m x0 t1) t1 (T.c t1 x2 t1)), (Steps.cons (Step.firstC x1 (T.c x1 x2 x1) (Step.right x0 h1)) (Steps.cons (Step.secondC (T.m x0 t1) (T.c x1 x2 x1) h1) (Steps.cons (Step.thirdC (T.m x0 t1) t1 (Step.firstC x2 x1 h1)) (Steps.cons (Step.thirdC (T.m x0 t1) t1 (Step.thirdC t1 x2 h1)) (Steps.refl _))))), (Steps.cons (Step.left (T.c t1 x2 x1) (Step.rightR x0 h1)) (Steps.cons (Step.right (T.r x0 t1) (Step.thirdC t1 x2 h1)) (Steps.cons (Step.root (Root.r10 x0 t1 x2)) (Steps.refl _))))⟩
    | @secondC _ _ t1 _ h1 =>
      exact ⟨(T.c (T.m x0 x1) x1 (T.c x1 t1 x1)), (Steps.cons (Step.thirdC (T.m x0 x1) x1 (Step.secondC x1 x1 h1)) (Steps.refl _)), (Steps.cons (Step.root (Root.r10 x0 x1 t1)) (Steps.refl _))⟩
    | @thirdC _ _ _ t1 h1 =>
      exact ⟨(T.c (T.m x0 t1) t1 (T.c t1 x2 t1)), (Steps.cons (Step.firstC x1 (T.c x1 x2 x1) (Step.right x0 h1)) (Steps.cons (Step.secondC (T.m x0 t1) (T.c x1 x2 x1) h1) (Steps.cons (Step.thirdC (T.m x0 t1) t1 (Step.firstC x2 x1 h1)) (Steps.cons (Step.thirdC (T.m x0 t1) t1 (Step.thirdC t1 x2 h1)) (Steps.refl _))))), (Steps.cons (Step.left (T.c x1 x2 t1) (Step.rightR x0 h1)) (Steps.cons (Step.right (T.r x0 t1) (Step.firstC x2 t1 h1)) (Steps.cons (Step.root (Root.r10 x0 t1 x2)) (Steps.refl _))))⟩
end submission.Austin13764
    ...
    | @thirdC _ _ _ t1 h1 =>
      ...
      | root hr =>
        ...
        · rw [ho]
          ...
          subst x2
          subst x3
          exact ⟨(T.c (T.m x0 (T.r x1 q0)) q0 (T.c q0 q1 q0)), (Steps.cons (Step.firstC q0 (T.c q0 q1 q0) (Step.right x0 (Step.rightR x1 (Step.root (Root.r6 q0 q1))))) (Steps.refl _)), (Steps.cons (Step.root (Root.r12 x0 x1 q0 q1)) (Steps.refl _))⟩
        · rw [ho]
          cases he
        · rw [ho]
          cases he
...
namespace submission.Austin13764
open T
theorem peak12 (x0 : T) (x1 : T) (x2 : T) (x3 : T) {u : T} (h : Step (T.m (T.c x0 x1 x2) (T.c x2 x3 x2)) u) : Join (T.c (T.m x0 (T.r x1 x2)) x2 (T.c x2 x3 x2)) u := by
  cases h with
  | root hr =>
    rcases root_cases hr with ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩
    · rw [ho]
    ...
    · rw [ho]
      ...
      subst x2
      subst x3
      exact ⟨(T.c (T.m q0 (T.r q1 q2)) q2 (T.c q2 q3 q2)), (Steps.refl _), (Steps.refl _)⟩
    · rw [ho]
      have e0 := (T.m.inj he).1
      have e1 := (T.m.inj he).2
      have e2 := e0.symm
  ...
  | @left _ t0 _ h0 =>
    ...
    | root hr =>
      ...
      · rw [ho]
        cases he
    | @firstC _ t1 _ _ h1 =>
      exact ⟨(T.c (T.m t1 (T.r x1 x2)) x2 (T.c x2 x3 x2)), (Steps.cons (Step.firstC x2 (T.c x2 x3 x2) (Step.left (T.r x1 x2) h1)) (Steps.refl _)), (Steps.cons (Step.root (Root.r12 t1 x1 x2 x3)) (Steps.refl _))⟩
    | @secondC _ _ t1 _ h1 =>
      exact ⟨(T.c (T.m x0 (T.r t1 x2)) x2 (T.c x2 x3 x2)), (Steps.cons (Step.firstC x2 (T.c x2 x3 x2) (Step.right x0 (Step.leftR x2 h1))) (Steps.refl _)), (Steps.cons (Step.root (Root.r12 x0 t1 x2 x3)) (Steps.refl _))⟩
    | @thirdC _ _ _ t1 h1 =>
      exact ⟨(T.c (T.m x0 (T.r x1 t1)) t1 (T.c t1 x3 t1)), (Steps.cons (Step.firstC x2 (T.c x2 x3 x2) (Step.right x0 (Step.rightR x1 h1))) (Steps.cons (Step.secondC (T.m x0 (T.r x1 t1)) (T.c x2 x3 x2) h1) (Steps.cons (Step.thirdC (T.m x0 (T.r x1 t1)) t1 (Step.firstC x3 x2 h1)) (Steps.cons (Step.thirdC (T.m x0 (T.r x1 t1)) t1 (Step.thirdC t1 x3 h1)) (Steps.refl _))))), (Steps.cons (Step.right (T.c x0 x1 t1) (Step.firstC x3 x2 h1)) (Steps.cons (Step.right (T.c x0 x1 t1) (Step.thirdC t1 x3 h1)) (Steps.cons (Step.root (Root.r12 x0 x1 t1 x3)) (Steps.refl _))))⟩
  | @right _ _ t0 h0 =>
    cases h0 with
    | root hr =>
      rcases root_cases hr with ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩ | ⟨q0, q1, q2, q3, he, ho⟩
      ...
      · rw [ho]
        cases he
    | @firstC _ t1 _ _ h1 =>
      exact ⟨(T.c (T.m x0 (T.r x1 t1)) t1 (T.c t1 x3 t1)), (Steps.cons (Step.firstC x2 (T.c x2 x3 x2) (Step.right x0 (Step.rightR x1 h1))) (Steps.cons (Step.secondC (T.m x0 (T.r x1 t1)) (T.c x2 x3 x2) h1) (Steps.cons (Step.thirdC (T.m x0 (T.r x1 t1)) t1 (Step.firstC x3 x2 h1)) (Steps.cons (Step.thirdC (T.m x0 (T.r x1 t1)) t1 (Step.thirdC t1 x3 h1)) (Steps.refl _))))), (Steps.cons (Step.left (T.c t1 x3 x2) (Step.thirdC x0 x1 h1)) (Steps.cons (Step.right (T.c x0 x1 t1) (Step.thirdC t1 x3 h1)) (Steps.cons (Step.root (Root.r12 x0 x1 t1 x3)) (Steps.refl _))))⟩
    | @secondC _ _ t1 _ h1 =>
      exact ⟨(T.c (T.m x0 (T.r x1 x2)) x2 (T.c x2 t1 x2)), (Steps.cons (Step.thirdC (T.m x0 (T.r x1 x2)) x2 (Step.secondC x2 x2 h1)) (Steps.refl _)), (Steps.cons (Step.root (Root.r12 x0 x1 x2 t1)) (Steps.refl _))⟩
    | @thirdC _ _ _ t1 h1 =>
      exact ⟨(T.c (T.m x0 (T.r x1 t1)) t1 (T.c t1 x3 t1)), (Steps.cons (Step.firstC x2 (T.c x2 x3 x2) (Step.right x0 (Step.rightR x1 h1))) (Steps.cons (Step.secondC (T.m x0 (T.r x1 t1)) (T.c x2 x3 x2) h1) (Steps.cons (Step.thirdC (T.m x0 (T.r x1 t1)) t1 (Step.firstC x3 x2 h1)) (Steps.cons (Step.thirdC (T.m x0 (T.r x1 t1)) t1 (Step.thirdC t1 x3 h1)) (Steps.refl _))))), (Steps.cons (Step.left (T.c x2 x3 t1) (Step.thirdC x0 x1 h1)) (Steps.cons (Step.right (T.c x0 x1 t1) (Step.firstC x3 t1 h1)) (Steps.cons (Step.root (Root.r12 x0 x1 t1 x3)) (Steps.refl _))))⟩
end submission.Austin13764
...
noncomputable instance modelMagma : Magma CM := ⟨Austin13764.opposite⟩
end submission

theorem submission : Goal := by
  refine ⟨submission.CM, submission.modelMagma, ?_, ?_⟩
  · intro x y z
    exact (submission.Austin13764.equation32294 x y z).symm
  · intro h
